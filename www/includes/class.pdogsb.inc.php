...
/* connexion en externe
    ...
    private static $serveur = 'db5017892270.hosting-data.io';
    private static $bdd = 'dbname=dbs12930308';
    private static $user = 'dbu1499016';
    private static $mdp = 'SananesMargalith2025';
    private static $monPdo;
    private static $monPdoGsb = null;
    ...
    */
     ...
     */
    private function __construct() { //initialise les variables qui n'ont pas été initialisés
     ...
     */
    public function __destruct() { //sert a détruire la classe PdoGsb pour libérer de l'espace
        PdoGsb::$monPdo = null;
    }
     ...
     */
    public static function getPdoGsb() { //crée l'unique objet de la classe
    ...
    public function majFraisHorsForfait($idVisiteur, $mois, $libelle, $date, $montant) {
        ...
        $requetePrepare = PdoGSB::$monPdo->prepare(
                ...
                . 'SET lignefraishorsforfait.montant = :unMontant, lignefraishorsforfait.libelle = :unLibelle, lignefraishorsforfait.date =:unDate  '
                . 'WHERE lignefraishorsforfait.idvisiteur = :unIdVisiteur '
                . 'AND lignefraishorsforfait.mois = :unMois '
        );
        $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
    ...
    public function ValiderFrais($idVisiteur, $montant) {
        $requetePrepare = PdoGSB::$monPdo->prepare(
                'SELECT SUM (fraisforfait.montant*lignefraisforfait.quantite)'
                . 'FROM lignefraisforfait '
                . 'INNER JOIN fraisforfait'
                . 'ON fraisforfait.id = lignefraisforfait.idfraisforfait'
                . 'WHERE fraisforfait*Montant'



//    . 'WHERE lignefraisforfait.idvisiteur = :unIdVisiteur '
//    . 'AND fraisforfait.montant= :unMontant '
//    . 'ORDER BY lignefraisforfait.idfraisforfait'
        );
        $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
