 ...
 * @return vrai ou faux
 */
function estConnecteV() { // On déclare la fonction 
    return isset($_SESSION['idVisiteur']); // retourne si oui ou non il y'a qqchose ds la variable Session ds la collone idVisiteur
}
...
function connecterV($idVisiteur, $nom, $prenom) {
    ...
    $_SESSION['nom'] = $nom; // ds la collone nom, je met nom
...
function ajouterErreur($msg) {
    if (!isset($_REQUEST['erreurs'])) { // isset = est ce que ca contient qqchose 
        $_REQUEST['erreurs'] = array(); // une superglobale = permet de relier les variables entre elles 
    }
